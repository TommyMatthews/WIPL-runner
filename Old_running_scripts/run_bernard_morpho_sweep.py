...
morpho_list = ['body_wing_leg', 'body_leg', 'body'] # leaving out 'body_wing' as already run
    ...
    for scale, scale_factor in scale_run_list.items():
        for pol in pol_run_dict.keys():
            for morpho in morpho_list:
                    ...
                    SAVE_PATH = r"C:\Users\NCAS\Documents\Tommy\Bernard_run_outputs\parameterised\\morpho_analysis\\"
