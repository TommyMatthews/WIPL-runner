...
PROJECT_PATH = r"E:\Working_Copy\Multi_moth_simulations\spatial_shift\Bernard_body_wing_x_shift"
...
for coordinate in coordinates:
    for pol in pol_run_dict.keys():
        ...
        SymbolsList.SetSymbolByName("x_shift_from_origin", coordinate)
        ...
        BASE_FILE_NAME = f"Bernard_shift_{frequency_name}_x{counter}_{pol}"
        SAVE_PATH =r"C:\Users\NCAS\Documents\Tommy\multi_moth_outputs\x_shift_tests\bernard_wings\\"
